---
title: 搭建zellij+alacritty终端环境
tags:
---

# 搭建zellij+alacritty终端环境

## 一、下载alacritty和zellij

```shell
# 下载rust工具包(如果不用cargo安装alacritty和zellij，则可以不用下载)
...
将zellij设为默认启用(废弃！！！！直接在alacritty中通过shell配置直接启动zellij)
